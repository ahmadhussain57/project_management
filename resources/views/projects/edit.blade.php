...
<body class="bg-slate-50 text-slate-800 font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center py-10 px-4">
        ...
        <div class="mb-6 text-center">
            <h2 class="text-3xl font-bold text-slate-700">Edit Project</h2>
            <p class="text-slate-500 mt-1">Update your project details and timelines below</p>
        </div>
        ...
        <form action="{{route('projects.update', $project->id)}}" method="post"
            ...
            <div class="mb-5">
                ...
                <input type="text" name="name" id="name" placeholder="Enter project name" value="{{ $project->name }}"
            ...
            <div class="mb-5">
                ...
                <textarea name="description" id="description" rows="4" placeholder="Describe the project..."
                    class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none">{{ $project->description }}</textarea>
            </div>

            <!-- Start Date & End Date (Side by Side Layout) -->
